  ...
  return (
    <div className="relative mx-auto w-full max-w-lg">
      ...
      >
        ...
        <text x="240" y="234" textAnchor="middle" fill="#94a3b8" fontSize="8">
          Décider · Former · Déployer
        </text>
        ...
        <text x="240" y="68" textAnchor="middle" fill="#94a3b8" fontSize="7">
          Diagnostic 360°
        </text>
        ...
        <circle
          ...
          cy="358"
          r="8"
          fill="rgba(214,168,90,0.15)"
          stroke="rgba(214,168,90,0.4)"
          strokeWidth="1"
        />
        <text
          x="220"
        ...
        <text x="240" y="378" textAnchor="middle" fill="#94a3b8" fontSize="7">
          ROI & adoption
        </text>
        ...
        <text x="90" y="223" textAnchor="middle" fill="#94a3b8" fontSize="7">
          Équipes & outils
        </text>
        ...
        <text x="390" y="223" textAnchor="middle" fill="#94a3b8" fontSize="7">
          RAG · Agents · Auto
        </text>
        ...
        <text x="135" y="123" textAnchor="middle" fill="#94a3b8" fontSize="7">
          Impact / effort
        </text>
        ...
        <text x="345" y="123" textAnchor="middle" fill="#94a3b8" fontSize="7">
          Charte & données
        </text>
        ...
        <text x="135" y="323" textAnchor="middle" fill="#94a3b8" fontSize="7">
          Parcours & ateliers
        </text>
        ...
        <text x="345" y="323" textAnchor="middle" fill="#94a3b8" fontSize="7">
          Prototypes & API
        </text>
